    ...
    <div class="container max-w-6xl mx-auto px-4 py-8">
      <div class="flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-muted-foreground font-mono">
        <div>
          ...
          <a href="https://push.michaelschieben.com/2026/01/05/hello-hallo-neue-webseite/" class="hover:text-foreground transition-colors">every decoding is another encoding</a>
        </div>
